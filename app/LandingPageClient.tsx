...
import { Upload, Sparkles, BarChart3, MessageSquare, FileQuestion, Target, Mail, Phone, MapPin } from "lucide-react"
...
export default function LandingPageClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 relative overflow-hidden">
      {/* Corner Gradients */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#EF629F] to-[#EECDA3] opacity-20 blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-[#EF629F] to-[#EECDA3] opacity-20 blur-3xl translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
      <div className="relative z-10">
        ...
        <header className="container mx-auto px-4 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <Button variant="outline" className="hover:bg-slate-100 transition-colors duration-200 bg-transparent">
                Try out for free
              </Button>
              <Button
        ...
        <section className="container mx-auto px-4 py-12 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
            Transform your job search with AI-powered resume optimization, interview preparation, and personalized
            career coaching.
          </p>
        </section>
        ...
        <section className="container mx-auto px-4 py-16 text-center">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 sm:p-12 text-white">
            ...
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Join thousands of professionals who have already upgraded their job search with Finally.
            </p>
            <Button
              size="lg"
        ...
        <footer className="bg-slate-800 text-white py-6">
          <div className="container mx-auto px-4">
            ...
            <div className="border-t border-slate-700 mt-4 pt-4 text-center text-sm text-slate-400">
              <p>&copy; 2024 Finally. All rights reserved. | Privacy Policy | Terms of Service</p>
            </div>
          </div>
        </footer>
      </div>
